...
// Now to use this component, we are going to include it in the routes
// where we need to have the childProps passed in.

// Above from: https://serverless-stack.com/chapters/add-the-session-to-the-state.html
